...
import { Search, Filter, Users, Calendar, Phone, MapPin, FileText, X, User } from 'lucide-react';
              ...
              <div key={patient.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 px-3 py-2 bg-teal-500 text-white text-sm rounded-lg hover:bg-teal-600 transition-colors"
                  >
                    View Details
                  </button>
                  <button
